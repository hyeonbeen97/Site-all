          ...
          >
                    ...
                    <div className="slider s1 container">
                        <div className="text">
                            ...
                            <Link to="/" className="more button-red">더 알아보기</Link>
                        </div>
                        <div className="img" aria-label="hidden">
                            <img src="./assets/images/slider/slider_tennis__icon.png" alt="이미지1" />
                            <img src="./assets/images/slider/slider_tennis__icon.png" alt="이미지2" />
                            <img src="./assets/images/slider/slider_tennis__icon.png" alt="이미지3" />
                        </div>
